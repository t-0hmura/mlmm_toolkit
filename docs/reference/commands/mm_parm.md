...
Options:
  ...
  --allow-nonstandard-aa    Allow antechamber parameterization of residues that
                            look amino-acid-like (contain N/CA/C). Use with care
  ...
  --add-ter / --no-add-ter  Insert TER before/after target residues. When
                            ...
                            [default: add-ter]
  --add-h / --no-add-h      Add hydrogens using PDBFixer at the specified --ph.
                            [default: no-add-h]
  --ph FLOAT                pH used by PDBFixer when adding hydrogens (--add-h
                            True). Default: 7.0
