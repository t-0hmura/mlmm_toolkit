...
| **xTB** | Extended Tight-Binding | A semi-empirical quantum chemistry method; usable through a custom calculator, but not through the retired v0.3.3 electronic-embedding path. |
