"""Import smoke tests for mlmm_toolkit."""
...
_need_py311 = pytest.mark.skipif(
    ...
    reason="mlmm_toolkit.cli / cli_utils require Python >= 3.11",
)


def test_import_mlmm_toolkit():
    import mlmm_toolkit


def test_import_defaults():
    from mlmm_toolkit.defaults import MLMM_CALC_KW, GEOM_KW_DEFAULT, OPT_BASE_KW
...
def test_import_cli_utils():
    from mlmm_toolkit.cli_utils import parse_bool, run_cli
