...
`mlmm-toolkit` itself requires Python 3.11–3.12.
...
| `huggingface_hub.errors.GatedRepoError` on UMA load | UMA model is gated, not authenticated | `uma.md` — `hf auth login` |
