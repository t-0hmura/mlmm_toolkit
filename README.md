...
calc:
  ...
  H_double: false          # calculate and retrun Hessian as float64 when true, else float32
  ml_device: 'auto'
  ml_cuda_idx: 0
  mm_device: 'cpu'
  mm_cuda_idx: 0
