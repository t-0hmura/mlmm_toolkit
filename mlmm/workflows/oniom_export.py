...
# Each emitted Gaussian directive carries a chemistry decision; the function
# and its limitations document the format contract.
...
# Format-specific writer for Gaussian 16 ONIOM input.
def export_gaussian(
    parm7_path: Path,
...
# Format-specific writer for ORCA 5+ ExtTool input.
def export_orca(
    parm7_path: Path,
    model_pdb: Optional[Path],
    output_path: Path,
    ...
    if orcaff_path is None:
        ...
        # ORCA's MM module needs ORCAFF.prms generated by the bundled
